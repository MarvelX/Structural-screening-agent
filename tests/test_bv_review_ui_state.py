...
def test_project_review_state_summary_rows_localize_project_inventory() -> None:
    summaries = [
        ProjectReviewStateSummary(
            ...
            locked_gate_count=2,
            locked_quality_gate_ids=["calculation"],
            open_quality_gate_ids=["basis", "report"],
            management_action_count=5,
            blocking_action_count=4,
            overdue_action_count=2,
            earliest_due_date="2026-05-22",
            next_due_action_id="rfi-client-response-rfi-001",
    ...
    assert zh_rows == [
        {
            ...
            "超期待办": 2,
            "最早到期": "2026-05-22",
            "最早到期待办": "rfi-client-response-rfi-001",
            "工作流状态": "阻塞",
    ...
    assert en_rows == [
        {
            ...
            "Timeline Events": 8,
            "Locked Gates": 2,
            "Locked Quality Gates": "Calculation Gate",
            "Open Quality Gates": "Review Basis Gate, Issue Gate",
            "Project Actions": 5,
            "Blocking Actions": 4,
            "Overdue Actions": 2,
            "Earliest Due": "2026-05-22",
            "Next Due Action": "rfi-client-response-rfi-001",
